...
**Klemp, M., Bassek, M., Garnica Caparròs, M., Bakhtiar, L. A., & Memmert, D. (2026). The use of machine learning in performance analysis in team sports: An umbrella review of reviews. *Journal of Sports Sciences*. https://doi.org/10.1080/02640414.2026.2636863**

---

This repository contains the open-science data files accompanying the umbrella review manuscript *"The Use of Machine Learning in Performance Analysis in Team Sports: An Umbrella Review of Reviews"*. The data support all quantitative analyses reported in the manuscript and are provided to ensure transparency and reproducibility.
